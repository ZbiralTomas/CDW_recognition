...
# python socket_connection_camera.py --cam 1 --sample material --ip 169.254.120.100 --port 1035
...
def is_contact(mean_channels_reference, image, sensitivity_to_change=8, relative_left=0.3, relative_width=0.05):
...
while True:
    ...
    image_for_plotting = cv2.putText(decoded_image, weight_str, text_position, font, font_scale, font_color,
                                     font_thickness)
    if contact_detected:
